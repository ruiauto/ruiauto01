...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/ruiauto01
```

A live public deployment of this template is available at [https://ruiauto01.templates.workers.dev](https://ruiauto01.templates.workers.dev)
